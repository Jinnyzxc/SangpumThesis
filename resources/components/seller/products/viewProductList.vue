<template>
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <td class="w-4 p-4">
                                        <div class="flex items-center">
                                            <input id="checkbox" type="checkbox" v-model="product.product_name[true]"
                                    ...
                                    <td
                                        ...
                                        <table class="justify-self-endjustify-center">
                                            ...
                                            <tbody v-for="description in product.salesInfo">
                                                <tr>
                                                    <td class="px-4">
    ...
    <AddProductForm :showAddToCart="showCart"></AddProductForm>
</template>
<script>
