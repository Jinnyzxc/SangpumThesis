<template>
    ...
    <div
        ...
        <div class="w-full mb-1">
            <toolbarHeader :title="titleHeader" :toolBarMenu="titleList">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                    <img class="w-10 h-10 rounded-full" src="" alt="name avatar">
                                    <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                        <div class="text-base font-semibold text-gray-900 dark:text-white"> name
                                        </div>
                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400"> email
                                        </div>
                                    </div>
                                </td>
                                <td
                                ...
                                <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex items-center">
                                        if(eq.status == "Active") <div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2">
                                        </div> else <div class="h-2.5 w-2.5 rounded-full bg-red-500 mr-2"></div> end status
